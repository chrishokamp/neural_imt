...
# TODO: this validator depends upon us having a file of references, but for IMT the references are generated on the fly
# TODO: therefore we need to write all the suffixes to a temporary file and validate against that
